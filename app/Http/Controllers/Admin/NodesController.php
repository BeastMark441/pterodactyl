...
class NodesController extends Controller
{
    ...
    /**
     * Отображает страницу создания нового узла.
     */
    ...
    /**
     * Контроллер для создания нового узла в системе.
     *
    ...
    /**
     * Удаляет несколько отдельных аллокаций с узла.
     *
     * @throws \Pterodactyl\Exceptions\Service\Allocation\ServerUsingAllocationException
     */
    ...
    /**
     * Удаляет все аллокации для конкретного IP на узле.
     */
    ...
    /**
     * Устанавливает псевдоним для конкретной аллокации на узле.
     *
     * @throws \Pterodactyl\Exceptions\Model\DataValidationException
     * @throws \Pterodactyl\Exceptions\Repository\RecordNotFoundException
     */
    ...
    /**
     * Создает новые аллокации на узле.
     *
