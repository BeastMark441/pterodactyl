            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="alert alert-info">
                        <p>Указание пароля пользователя необязательно. В письме новому пользователю будет предложено создать пароль при первом входе. Если вы укажете пароль здесь, вам придётся самостоятельно передать его пользователю другим способом.</p>
                    </div>
