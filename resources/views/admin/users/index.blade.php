                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Серверы, владельцем которых является этот пользователь.">Владеет серверами</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Серверы, к которым этот пользователь имеет доступ как дополнительный пользователь.">Имеет доступ</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
