                ...
                <table class="table table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Сервера, владельцем которых отмечен этот пользователь.">Владеет серверами</span></th>
                            <th class="text-center"><span data-toggle="tooltip" data-placement="top" title="Сервера, к которым этот пользователь имеет доступ как субпользователь.">Имеет доступ</span></th>
                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
