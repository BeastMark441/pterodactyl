...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Оставьте поле пустым, чтобы сохранить текущий пароль пользователя. Пользователь не получит уведомление при изменении пароля.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">С этой учетной записью не должно быть связано серверов, чтобы ее можно было удалить.</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
