...
<div class="row">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Язык по умолчанию, который будет использоваться при отображении панели для этого пользователя.</small></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="form-group no-margin-bottom">
                        ...
                        <div>
                            ...
                            <p class="text-muted small">Оставьте поле пустым, чтобы сохранить текущий пароль пользователя. Пользователь не получит уведомление, если пароль будет изменён.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <div>
                            ...
                            <p class="text-muted"><small>Если установить значение «Да», пользователь получит полный административный доступ.</small></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="col-xs-12">
        <div class="box box-danger">
            ...
            <div class="box-body">
                <p class="no-margin">Чтобы удалить эту учётную запись, с ней не должно быть связано ни одного сервера.</p>
            </div>
            <div class="box-footer">
                <form action="{{ route('admin.users.view', $user->id) }}" method="POST">
                    {!! csrf_field() !!}
