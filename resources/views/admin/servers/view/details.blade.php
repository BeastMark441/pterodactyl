...
@section('content-header')
    <h1>{{ $server->name }}<small>Редактирование параметров этого сервера, включая владельца и контейнер.</small></h1>
    <ol class="breadcrumb">
            ...
            <form action="{{ route('admin.servers.view.details', $server->id) }}" method="POST">
                <div class="box-body">
                    <div class="form-group">
                        ...
                        <p class="text-muted small">Ограничения по символам: <code>a-zA-Z0-9_-</code> и <code>[Пробел]</code>.</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">Оставьте пустым, если не хотите назначать внешний идентификатор этому серверу. Внешний ID должен быть уникальным для этого сервера и не использоваться никакими другими серверами.</p>
                    </div>
                    <div class="form-group">
                        ...
                        <p class="text-muted small">Вы можете изменить владельца этого сервера, указав здесь email другого пользователя в системе. Если вы это сделаете, новый токен безопасности daemon будет создан автоматически.</p>
                    </div>
                    <div class="form-group">
