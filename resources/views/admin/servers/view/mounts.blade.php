...
@section('title')
    Сервер — {{ $server->name }}: Точки монтирования
@endsection

@section('content-header')
    <h1>{{ $server->name }}<small>Управление точками монтирования сервера.</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="col-sm-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Доступные точки монтирования</h3>
                </div>
                            ...
                            <tr>
                                ...
                                @if (! in_array($mount->id, $server->mounts->pluck('id')->toArray()))
                                    <td class="col-sm-2 middle">
                                        <span class="label label-primary">Не примонтировано</span>
                                    </td>
                                ...
                                @else
                                    <td class="col-sm-2 middle">
                                        <span class="label label-success">Примонтировано</span>
                                    </td>
