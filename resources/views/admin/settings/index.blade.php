...
@section('content-header')
    <h1>Настройки панели<small>Настройте Pterodactyl по своему вкусу.</small></h1>
    <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-muted"><small>Это имя используется по всей панели и в письмах, отправляемых клиентам.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="control-label">Требовать двухфакторную аутентификацию (2FA)</label>
                                <div>
                                    ...
                                    <p class="text-muted"><small>Если включено, любая учетная запись, попадающая в выбранную группу, должна будет включить 2FA для использования панели.</small></p>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
