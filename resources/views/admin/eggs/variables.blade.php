...
@section('title')
    Egg &rarr; {{ $egg->name }} &rarr; Переменные
@endsection

@section('content-header')
    <h1>{{ $egg->name }}<small>Управление переменными для этого Egg.</small></h1>
    <ol class="breadcrumb">
                ...
                <form action="{{ route('admin.nests.egg.variables.edit', ['egg' => $egg->id, 'variable' => $variable->id]) }}" method="POST">
                    <div class="box-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12">
                                <p class="text-muted small">К этой переменной можно обратиться в команде запуска, используя <code>{{ $variable->env_variable }}</code>.</p>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Создать новую переменную Egg</h4>
            </div>
            <form action="{{ route('admin.nests.egg.variables', $egg->id) }}" method="POST">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            <p class="text-muted small">К этой переменной можно обратиться в команде запуска, указав <code>@{{environment variable value}}</code>.</p>
                        </div>
                    </div>
                    <div class="form-group">
