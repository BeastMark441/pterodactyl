...
@section('content-header')
    <h1>{{ $node->name }}<small>Краткий обзор вашего узла.</small></h1>
    <ol class="breadcrumb">
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">Удаление узла является необратимым действием и немедленно удалит этот узел с панели. Для продолжения не должно быть серверов, связанных с этим узлом.</p>
                    </div>
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">Этот узел находится в</span>
                                <span class="info-box-number">Режиме обслуживания</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['disk']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">Выделенное дисковое пространство</span>
