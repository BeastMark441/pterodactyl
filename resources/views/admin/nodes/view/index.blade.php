...
@section('content-header')
    <h1>{{ $node->name }}<small>Краткий обзор вашей ноды.</small></h1>
    <ol class="breadcrumb">
    ...
    <div class="col-xs-12">
        <div class="nav-tabs-custom nav-tabs-floating">
            <ul class="nav nav-tabs">
                <li class="active"><a href="{{ route('admin.nodes.view', $node->id) }}">О ноде</a></li>
        ...
        <div class="row">
            ...
            <div class="col-xs-12">
                <div class="box box-danger">
                    ...
                    <div class="box-body">
                        <p class="no-margin">Удаление ноды — необратимое действие, и эта нода будет немедленно удалена из панели. Чтобы продолжить, с этой нодой не должно быть связано ни одного сервера.</p>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-orange">
                            ...
                            <div class="info-box-content" style="padding: 23px 10px 0;">
                                <span class="info-box-text">Эта нода находится в режиме</span>
                                <span class="info-box-number">Обслуживания</span>
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    <div class="col-sm-12">
                        <div class="info-box bg-{{ $stats['memory']['css'] }}">
                            ...
                            <div class="info-box-content" style="padding: 15px 10px 0;">
                                <span class="info-box-text">Выделено памяти</span>
