...
@section('content-header')
    <h1>Монты<small>Настройка и управление дополнительными точками монтирования для серверов.</small></h1>
    <ol class="breadcrumb">
        <li><a href="{{ route('admin.index') }}">Админ</a></li>
        <li class="active">Монты</li>
    </ol>
@endsection
        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Список Монт</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#newMountModal">Создать новый</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts') }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Создать Монт</h4>
                    </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">Уникальное имя, используемое для различения этого монтирования от другого.</p>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <p class="text-muted small">Длинное описание для этого монтирования, должно быть менее 191 символа.</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">Где монтирование будет доступно внутри контейнера.</p>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <p class="text-muted small">Монтирование только для чтения внутри контейнера?</p>
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Монтируемое пользователем</label>
                                ...
                                <p class="text-muted small">Должны ли пользователи иметь возможность монтировать это самостоятельно?</p>
                            </div>
                        </div>
                    </div>
