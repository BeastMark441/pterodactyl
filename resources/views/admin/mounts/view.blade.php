...
@section('title')
    Точки монтирования &rarr; Просмотр &rarr; {{ $mount->id }}
@endsection
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{ route('admin.mounts') }}">Точки монтирования</a></li>
        ...
        <div class="col-sm-6">
            <div class="box box-primary">
                <div class="box-header with-border">
                    <h3 class="box-title">Сведения о точке монтирования</h3>
                </div>
        ...
        <div class="col-sm-6">
            <div class="box">
                <div class="box-header with-border">
                    ...
                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addEggsModal">Добавить Eggs</button>
                    </div>
                </div>
            ...
            <div class="box">
                <div class="box-header with-border">
                    <h3 class="box-title">Ноды</h3>

                    <div class="box-tools">
                        <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addNodesModal">Добавить ноды</button>
                    </div>
                </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.eggs', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Добавить Eggs</h4>
                    </div>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.mounts.nodes', $mount->id) }}" method="POST">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Добавить ноды</h4>
                    </div>

                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-md-12">
                                <label for="pNodes">Ноды</label>
...
@section('footer-scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#pEggs').select2({
                placeholder: 'Выберите eggs..',
            });

            $('#pNodes').select2({
                placeholder: 'Выберите ноды..',
            });
            ...
            $('button[data-action="detach-egg"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    swal({ type: 'success', title: 'Egg отвязан.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Упс!',
            ...
            $('button[data-action="detach-node"]').click(function (event) {
                ...
                $.ajax({
                    ...
                    element.parent().parent().addClass('warning').delay(100).fadeOut();
                    swal({ type: 'success', title: 'Нода отвязана.' });
                }).fail(function (jqXHR) {
                    console.error(jqXHR);
                    swal({
                        title: 'Упс!',
