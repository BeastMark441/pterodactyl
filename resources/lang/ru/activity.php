...
return [
    ...
    'server' => [
        ...
        'schedule' => [
            ...
            'update' => 'Расписание :name обновлено',
            'execute' => 'Расписание :name выполнено вручную',
            'delete' => 'Расписание :name удалено',
        ],
        'task' => [
            'create' => 'Создана новая задача ":action" для расписания :name',
            'update' => 'Задача ":action" для расписания :name обновлена',
