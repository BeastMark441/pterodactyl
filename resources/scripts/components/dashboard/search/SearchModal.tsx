    ...
    return (
        <Formik
            ...
            validationSchema={object().shape({
                term: string().min(3, 'Пожалуйста, введите не менее трех символов, чтобы начать поиск.'),
            })}
                ...
                <Modal {...props}>
                    <Form>
                        <FormikFieldWrapper
                            ...
                            description={'Введите имя сервера, uuid или распределение, чтобы начать поиск.'}
                        >
                            <SearchWatcher />
