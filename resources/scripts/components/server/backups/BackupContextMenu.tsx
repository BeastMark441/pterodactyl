...
export default ({ backup }: Props) => {
    ...
    return (
        <>
            ...
            >
                <p>
                    Ваш сервер будет остановлен. Вы не сможете управлять его питанием, пользоваться файловым
                    менеджером или создавать дополнительные резервные копии до завершения процесса.
                </p>
            ...
            >
                Это необратимая операция. После удаления резервную копию нельзя будет восстановить.
            </Dialog.Confirm>
