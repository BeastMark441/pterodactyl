    ...
    <>
        ...
        <div css={tw`flex-1 md:ml-4`}>
            ...
            <p css={tw`text-xs text-neutral-400`}>
                Последний раз запущен: {schedule.lastRunAt ? format(schedule.lastRunAt, "MMM do 'at' h:mma") : 'Никогда'}
            </p>
        </div>
        <div>
            <p
        ...
        <div>
            ...
            >
                {schedule.isProcessing ? 'Обрабатывается' : schedule.isActive ? 'Активно' : 'Неактивно'}
            </p>
        </div>
    </>
);
